...
from deepspeaker.constants import SAMPLE_RATE, NUM_FRAMES
...
def predict_embedding(model, audio_path, sr=SAMPLE_RATE):
    mfcc = sample_from_mfcc(read_mfcc(audio_path, sr), NUM_FRAMES)
